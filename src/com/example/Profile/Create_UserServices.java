...
public class Create_UserServices {

	public Create_UserServices() {

	}

	public static String data(String name,String cell,String experience,String c_salary,
			String join_date,String desig, String address,String idcard) {
		//
		String response = "";
		...
		//	HttpPost httpPost = new HttpPost("http://10.0.2.2/deliverysystem/order/add");
			HttpPost httpPost = new HttpPost("http://192.168.1.4/myphp/newuser.php");
